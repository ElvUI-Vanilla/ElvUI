...
local getn, tremove, tContains, tinsert, wipe = table.getnumber, tremove, tContains, tinsert, table.wipe
...
function E:Contruct_StaticPopups()
	...
	for index = 1, MAX_STATIC_POPUPS do
		...
		E:Kill(_G[name .. "ItemFrameNameFrame"])
		E:Kill(_G[name .. "ItemFrame"]:GetNormalTexture())
		E:SetTemplate(_G[name .. "ItemFrame"], "Default")
		E:StyleButton(_G[name .. "ItemFrame"])
		_G[name .. "ItemFrameIconTexture"]:SetTexCoord(unpack(E.TexCoords))
		E:SetInside(_G[name .. "ItemFrameIconTexture"])
	end
